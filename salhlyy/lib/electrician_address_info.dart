...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: const ElectricianAddressInfoLayout(phoneNumber: '+1234567890'),
    );
  }
}

class ElectricianAddressInfoLayout extends StatefulWidget {
  final String phoneNumber;
  const ElectricianAddressInfoLayout({super.key, required this.phoneNumber});

  @override
  _ElectricianAddressInfoLayoutState createState() => _ElectricianAddressInfoLayoutState();
}

class _ElectricianAddressInfoLayoutState extends State<ElectricianAddressInfoLayout> {
  ...
  void _confirmAddress() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Electrician address saved successfully!')),
      );
        ...
        builder: (context) => AlertDialog(
          ...
          content: SizedBox(
            ...
            child: Column(
              ...
              children: [
                Text(
                  'Please confirm your electrician address details:',
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Failed to save electrician address: $e')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text(
          'Electrician Address Information',
          style: TextStyle(
            fontSize: 24,
            fontFamily: 'Playfair_Display',
            fontWeight: FontWeight.bold,
