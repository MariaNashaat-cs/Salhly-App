...
import 'fixerlist.dart';

class AddressAndDate extends StatefulWidget {
  ...
  @override
  _AddressAndDateState createState() => _AddressAndDateState();
}

class _AddressAndDateState extends State<AddressAndDate> {
  ...
  void _navigateToAddressInfo() async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AddressInfoLayout(phoneNumber: widget.phoneNumber),
      ),
    );
