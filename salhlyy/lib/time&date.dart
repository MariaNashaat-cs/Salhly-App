...
void main() async {
  ...
  runApp(const MaterialApp(
    home: DateTimePickerScreen(phoneNumber: 'guest'),
...
class DateTimePickerScreen extends StatefulWidget {
  ...
  const DateTimePickerScreen({super.key, required this.phoneNumber});

  @override
  _DateTimePickerScreenState createState() => _DateTimePickerScreenState();
}

class _DateTimePickerScreenState extends State<DateTimePickerScreen> with SingleTickerProviderStateMixin {
  ...
  final Color brandBackground = const Color(0xFFF8F9FA);
  ...
  void _confirmSelection() {
    if (_isDateAndTimeSelected) {
      // Save to database and navigate to next screen
      _saveToRealtimeDatabase().then((_) {
        Navigator.push(
          context,
          PageRouteBuilder(
            pageBuilder: (context, animation, secondaryAnimation) => AddressAndDate(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'When do you need the repair service?',
                        style: TextStyle(
                          fontFamily: 'Playfair_Display',
                          fontSize: 24,
